      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <Link to="/">
              <img src={logo} alt="Revolutech Logo" className="h-10" style={{ cursor: 'pointer' }} />
            </Link>
          </div>
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8">
              ...
              <li><Link to="/garage-list" className="font-medium text-gray-600 hover:text-primary cursor-pointer">Services</Link></li>
        ...
        {isMenuOpen && (
            <div className="md:hidden bg-white">
              <ul className="flex flex-col space-y-4 p-4">
                <li><Link to="/" className="font-medium text-primary cursor-pointer">Accueil</Link></li>
                <li><Link to="/garage-list" className="font-medium text-gray-600 cursor-pointer">Services</Link></li>
                <li><Link to="/about" className="font-medium text-gray-600 cursor-pointer">À propos</Link></li>
                <li><Link to="/contact" className="font-medium text-gray-600 cursor-pointer">Contact</Link></li>z
              </ul>
            </div>
        )}
      </header>
