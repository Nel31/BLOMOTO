        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8">
              ...
              <li><Link to="/login" className="font-medium text-xl text-gray-600 hover:text-primary cursor-pointer">Mon compte</Link></li>
              <li><Link to="/garage/1/dashboard" className="font-medium text-xl text-gray-600 cursor-pointer">Tableau de bord</Link></li>
            </ul>
          </nav>
